...
# IMPORTANT: Configurează calea către Tesseract
...
class AutoBarcodeScanner:
    ...
    def process_barcode(self, x1, y1, x2, y2):
        self.root.deiconify()
        self.status_label.config(text="⏳ Procesare...", fg="yellow")
        self.root.update()
        ...
        try:
            ...
            # OCR pentru extragerea textului
            text = pytesseract.image_to_string(screenshot, config='--psm 6')

            # Curăță textul (șterge spații, newlines)
